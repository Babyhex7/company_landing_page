...
// Strapi uses PLURAL endpoint names (e.g., /api/services, /api/projects)
// ============================================
...
// Services (collection type - plural)
...
// Projects (collection type - plural)
...
// Blog Posts (collection type - plural)
...
// Categories (collection type - plural)
export async function getCategories() {
  return fetchAPI<any[]>("categories", { populate: "*" });
}

// Testimonials (collection type - plural)
...
// Team Members (collection type - plural)
...
// Client Logos (collection type - plural)
